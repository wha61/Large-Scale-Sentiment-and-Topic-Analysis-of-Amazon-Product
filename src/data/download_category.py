...
def download_category(category):
    ...
    Downloads a specific category of Amazon Reviews 2023 dataset.
    """
    file_url = f"https://huggingface.co/datasets/McAuley-Lab/Amazon-Reviews-2023/resolve/main/raw/review_categories/{category}.jsonl"
    ...
    try:
        ...
        print(f"Error loading category '{category}': {e}")
        print("Please check the exact category name on readme (Case Sensitive!)")
        return
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        default="All_Beauty",
        help="The category name to download (e.g., All_Beauty, Electronics). Default is All_Beauty."
    )
